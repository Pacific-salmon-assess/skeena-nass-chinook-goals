...
model{
  ...
  sigma_R0 ~ gamma(2,1); 
  prob ~ beta(1,1);
  D_scale ~ beta(1,1); #was 1,1, trying 8,1 per curry's suggestion
...
generated quantities {
  ...
  //below is what I did for fraser pink, but I wonder if I should add A_obs?
